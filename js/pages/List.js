        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        If the challenge copies parts from a full level, it must be sufficiently different from the original. If the original level was already a 2 Player level, this rule will be enforced more strictly.
                    </p>
                        <h3>Submission Requirements</h3>
                    <p>
                        All records must be achieved solo.
                    </p>
                    <p>
                        Do not bind one key to both inputs (meaning you can't have one key that jumps with player 1 and player 2).
                    </p>
                    <p>
                    ...
                    <p>
                        Have clicks/taps in the video. Handcam will only be needed for levels that have the requirement for it.
                    </p>
                    <p>
                    ...
                    <p>
                        Once a level falls onto the Legacy List (#51 and below), we accept records for it for 24 hours after it falls off, then afterwards we never accept records for said level.
                    </p>
                </div>
            </div>
        </main>
